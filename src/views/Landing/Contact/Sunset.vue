<template>
  <!-- sun -->
  <div ref="sun" class="absolute bottom-20 w-48 h-48 left-1/2 transform -translate-x-1/2 rounded-full bg-yellow-200 backlight-sun transition duration-300"></div>

  <!-- sea -->
  <div ref="sea" class="absolute bottom-0 left-0 h-48 w-full bg-gradient-radial-to-b from-yellow-500 to-yellow-700 backlight-sea transition duration-300"></div>
  ...
  <div ref="beach" class="absolute bottom-0 left-0 h-24 w-full bg-black flex transition">
    ...
    <div class="text-yellow-600 h-full flex flex-col justify-center pl-3 md:pl-10">
      <p class="text-sm md:text-base">hudadamar21@gmail.com</p>
      <p class="text-sm md:text-base">copyright@2021. hudadamar21</p>
    </div>
